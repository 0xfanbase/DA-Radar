...
**The board plan (9 March 2026 circular)**
- The HKMA expects each bank's board to oversee and endorse a formal strategic business plan within six months of 9 March 2026. [S:3ec5b269b5dc, letter body, p.2]
- The plan should look for chances to adapt products, revenue models, customer engagement, risk management and operations. [S:3ec5b269b5dc, letter body, p.2]
- The plan may include small real-world trials through the Supervisory Incubator to test new business models. [S:3ec5b269b5dc, letter body, p.2]

**Launching a product**
- Before launch, a bank should discuss any VA activity with the HKMA and get feedback on its risk controls. [S:642680fa4467, AIs' VA-related proposals section, p.5]
- A registered institution (RI) is a bank the SFC has registered for securities business. An RI should tell the SFC and the HKMA before it starts or changes any VA activity. [S:8934af8cc884, para 5.6] That includes changes in the types of clients it serves. [S:8934af8cc884, para 5.6]
...
- A bank should not launch new products unless it is satisfied that its staff understand them and the rules that apply. [S:6ea96c41cccc, para 3.7.4]
- A bank must notify the HKMA before acquiring a new type of cryptoasset. [S:b7d630146e6c, para 2.1.2] It treats the asset as Group 2b, the group with the 1,250% risk weight, until the HKMA agrees another classification. [S:b7d630146e6c, para 2.1.2]
- If crypto risk management or capital falls short, the HKMA may consider capital add-ons, provisions or limits. [S:349a543ae2f0, para 3.6.6]
...
- A would-be majority controller must set out clear, detailed plans for the bank. [S:2baef0f142a0, para 32] The HKMA looks for a long-term commitment and the ability to add capital. [S:2baef0f142a0, para 34]
- A person needs the SFC's approval before becoming a substantial shareholder of a licensed corporation (LC), an SFC-licensed firm. [S:13f2903631f6, para 8.2.1] A substantial shareholder generally holds more than 10% of shares or voting power. [S:13f2903631f6, fn 32]
- Nobody may become a controller of a licensed stablecoin issuer except in the ways the Stablecoins Ordinance allows. [S:240be6833157, para 7.2.5] The issuer should track its controllers and seek the Monetary Authority's consent as the Ordinance requires. [S:240be6833157, para 7.2.5]
...
> **Analysis — not official**
> **Question:** What evidence would tell a bank to stop, pause or fix a digital-asset product?
> **How to think about it:**
> - Which stop tests were agreed at launch? Examples: client balances by a date, contribution per client, incident count (illustrative).
> - How do future income and future costs compare, including exit costs and leaving aside money already spent?
> - What does the exit involve? An RI must give seven business days' notice before it stops a regulated activity [S:8934af8cc884, para 5.1]. How would client assets be returned or moved?
> - Would a smaller scope keep most of the value?
> **What it depends on:** client demand; fixed-cost base; the capital group of any assets held; partner contracts; reputational effects of exiting.
> **Official signposts:** RI notice duties [S:8934af8cc884, paras 5.1, 5.6]; HKMA views on exit plans for new business models [S:5422156398b3, para 20].
> **What this is not:** Not a forecast, not advice, and not the regulator's view.

> **Analysis — not official**
> **Question:** How can a bank treat its regulator relationship as a business asset without confusing access with approval?
> **How to think about it:**
...
**To the CEO**
- The HKMA expected our board to endorse a strategic plan within six months of 9 March 2026. [S:3ec5b269b5dc, letter body, p.2]
- Under the planned custodian regime, banks already assessed for VA custody and already providing it are to get faster licensing. [S:f41a543388bc, para 51]

**To the CCO**
- We should discuss any new VA activity with the HKMA before launch. [S:642680fa4467, AIs' VA-related proposals section, p.5]
- As an RI, we give seven business days' notice before stopping a regulated activity. [S:8934af8cc884, para 5.1]

**To business heads**
- Group 2b cryptoassets on our own books take a 1,250% risk weight. [S:9e8d84c87168, Part XII CAE1 explanatory note, column (c), p.215]
- Buying a stake worth 5% or more of Tier 1 capital needs HKMA written consent. [S:13365a31e794, para 1.1]

**To Risk / CRO**
- A new type of cryptoasset stays in Group 2b until the HKMA agrees otherwise. [S:b7d630146e6c, para 2.1.2]
- The HKMA may consider capital add-ons or limits if our crypto risk management falls short. [S:349a543ae2f0, para 3.6.6]
...
1. **Strategic Review of Business Models amid Digital Transformation** — HKMA, 9 March 2026. Read page 2. Its footnote 3 links the Incubator circular. https://brdr.hkma.gov.hk/eng/doc-ldg/docId/getPdf/20260309-1-EN/20260309-1-EN.pdf
2. **Supervisory Policy Manual module on Major Acquisitions and Investments** — HKMA, November 2025. Read paras 1.1, 2.5 and 2.9. https://brdr.hkma.gov.hk/eng/doc-ldg/docId/getPdf/20251125-5-EN/CR-L-5.pdf
3. **Guideline on Minimum Criteria for Authorization** — HKMA, 27 February 2026. Read paras 9 and 28-36 on controllers. https://brdr.hkma.gov.hk/eng/doc-ldg/docId/getPdf/20260226-1-EN/20260227-1-EN.pdf
4. **Consultation Conclusions on regulating VA dealing** — FSTB and SFC, 24 December 2025. Read paras 31-36. https://apps.sfc.hk/edistributionWeb/gateway/EN/consultation/doc?refNo=25CP12
5. **Supervisory Policy Manual module on Classification of Cryptoassets** — HKMA, 27 November 2025. Read para 2.1.2 on new types of cryptoasset. https://brdr.hkma.gov.hk/eng/doc-ldg/docId/getPdf/20251125-15-EN/CRP-1.pdf

## Open items

- The HKMA has not published a follow-up on the board plans due around 9 September 2026 in the sources reviewed.
- No official source gives hurdle rates, fee levels or margins for bank digital-asset lines in Hong Kong.
- No public list of Supervisory Incubator participants exists in the sources reviewed.
