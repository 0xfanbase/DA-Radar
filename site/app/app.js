...
(function () {
  ...
  function renderMD(md) {
    ...
    tmp.querySelectorAll("blockquote").forEach(function (b) {   // labelled analysis boxes
      ...
      else if (st && /^Commercial and customer benefits/.test(st.textContent)) { b.className = "benefits"; b.setAttribute("aria-label", "Commercial and customer benefits"); }
    });
  ...
  function vHelp() {
    ...
    return '<article class="article"><p class="kicker">Help</p><h1 class="page-title">How to read this site</h1>' +
      ...
      "<h2>Commercial and customer benefits boxes</h2><p>A green box on each project and on the technology modules shows what customers and the bank gain, the evidence so far and its limits. Benefits come from official sources (often stated as aims) or from clearly labelled industry estimates. They are not a forecast by this site.</p>" +
